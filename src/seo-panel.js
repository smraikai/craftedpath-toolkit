...
import { TextControl, TextareaControl, PanelRow, RangeControl, Notice } from '@wordpress/components';
...
const SeoPanel = () => {
    ...
    // Get post data
    const { postTitle, seoTitle, seoDescription } = useSelect(
        (select) => {
...
registerPlugin('craftedpath-seo', {
    render: SeoPanel,
    icon: 'admin-settings', // Optional: Add a Dashicon or custom SVG icon
}); 